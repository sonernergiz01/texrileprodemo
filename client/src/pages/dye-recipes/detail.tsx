      ...
      <div className="container mx-auto py-6">
        <div className="mb-6">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-2xl font-bold tracking-tight">{recipe?.name || "Boya Reçetesi"}</h1>
              <p className="text-muted-foreground">{recipe?.description || "Boya reçetesi detayları"}</p>
            </div>
          </div>
        </div>
